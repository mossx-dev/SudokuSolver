...
[Constraint(DisplayName = "Modular Line", ConsoleName = "modularl")]
public class ModularLineConstraint : Constraint
{
    ...
    private readonly uint[] groupMasks = { 0b001001001, 0b010010010, 0b100100100 };

    private static int[] lowGroup = {1, 4, 7};

    private static int[] midGroup = {2, 5, 8};
    
    private static int[] highGroup = {3, 6, 9};
    
    private static int[][] groups = new int[][] { lowGroup, midGroup, highGroup };

    private int[] groupIndices = {-1, -1, -1};

    public ModularLineConstraint(Solver sudokuSolver, string options) : base(sudokuSolver)
    {
    ...
    {
        // Without a value in any spot modular lines cannot rule out any value
